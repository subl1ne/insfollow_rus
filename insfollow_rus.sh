...
alenavodonaeva="217566587"
borodylia="22288455"
nika_viper="240811483"
instagram="25025320"


if [[ ! -e celeb_id ]]; then
printf "%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n" $portraitambassadors $annasedakova $tabula_rasa_45 $lobodaofficial $tetyamotya $koval_now $natali_iashchuk $klavacoca $oleshev $pusshman $burimova $instagram $borodylia $nika_viper $alenavodonaeva $letoile_official $tv3russia $samburskaya $buzova86 $shurygina_vlog $ritadakota $sayonaraboy $_agentgirl_ > celeb_id
fi
